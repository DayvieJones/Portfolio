    ...
    <div>
      ...
      <main className="flex flex-col">
        ...
        >
          <div className="flex flex-col text-slate-300 gap-32 justify-center items-center lg:flex-row lg:gap-40">
            <div className="mx-5 px-5">
              <h1 className="text-5xl text-cyan-300 mb-3">
                Hey, ich bin David Johrden
              </h1>
              <h2 className="text-3xl text-cyan-100 mb-3">
                {"<Frontend Developer/>"}
              </h2>
              <p className="text-2xl text-cyan-400 mb-5">Sei gegrüßt</p>
              <a
                href="#about"
        ...
        >
          ...
          <div className=" lg:mt-12  flex flex-col bg-slate-600 mt-8 rounded-lg p-4 mx-auto border-4 border-double border-cyan-400 lg:w-[50%]">
        ...
        <section id="contact" className="container flex flex-col mx-auto">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col justify-center lg:flex-row lg:gap-5">
              {/* <div className="bg-slate-800 p-10 rounded-lg mx-auto text-center lg:w-[50%]">
              ...
              <div className="mt-20 text-center px-8 lg:w-[50%] bg-slate-800 p-10 rounded-xl">
                ...
                <a
                  ...
                  className="text-cyan-500 font-medium flex items-center text-lg mt-8 lg:mt-5 lg:text-xl lg:font-semibold hover:text-cyan-400"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
